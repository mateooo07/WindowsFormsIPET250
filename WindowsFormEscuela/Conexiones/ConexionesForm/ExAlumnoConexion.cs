...
namespace WindowsFormEscuela.Conexiones
{
    internal class ExAlumnoConexion : Conexion
    {
        public List<ExAlumno> LeerExAlumnos()
        {
            ...
            {
                throw new Exception("Error al leer ex-alumnos: " + ex.Message, ex);
            }
            finally
            {
                CerrarConexion();
        ...
        public void AgregarExAlumno(ExAlumno exalumno)
        {
            ...
            {
                throw new Exception("Error al agregar ex-alumno: " + ex.Message, ex);
            }
            finally
            {
                CerrarConexion();
        ...
        public bool EliminarExAlumno(int id)
        {
            ...
            {
                throw new Exception("Error al eliminar ex-alumno: " + ex.Message, ex);
            }
            finally
            {
                CerrarConexion();
        ...
        public void EditarExAlumno(ExAlumno exalumno)
        {
            ...
            {
                throw new Exception("Error al editar ex-alumno: " + ex.Message, ex);
            }
            finally
            {
                CerrarConexion();
        ...
        public List<ExAlumno> BuscarExAlumnos(string nombre, string carrera, string edad, string promedio, bool cursando)
        {
            ...
            {
                throw new Exception("Error al buscar ex-alumnos: " + ex.Message, ex);
            }
            finally
            {
                CerrarConexion();
